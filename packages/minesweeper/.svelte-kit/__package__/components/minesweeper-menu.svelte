<script>import Settings from './settings.form.svelte';
...
import { CLASSIC_GAME_PRESETS } from '../store';
...
function openModal(modal) {
    const windowElement = document.querySelector('#' + formatPid(windowState.processId, 'window'));
