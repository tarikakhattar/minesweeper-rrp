<script>import { Panel } from '@w2k/ui';
...
<style>.game {
  ...
  padding: calc(var(--game-area-border-width) + var(--game-area-padding)) var(--game-area-padding) var(--game-area-padding) calc(var(--game-area-border-width) + var(--game-area-padding));
  box-shadow: inset 1.05px 1.05px var(--win-3d-objects-color-lighter-1), inset 2.05px 2.05px var(--win-3d-objects-color-lighter-1), inset 3.05px 3.05px var(--win-3d-objects-color-lighter-1) !important;
}
...
:global(.game .stats) {
  ...
  width: calc(100% - 1px);
  background: var(--win-3d-objects-color);
  box-shadow: inset -1.05px -1.05px var(--win-3d-objects-color-lighter-1), inset 1.05px 1.05px var(--win-3d-objects-color-darker-1), inset -2.05px -2.05px var(--win-3d-objects-color-lighter-1), inset 2.05px 2.05px var(--win-3d-objects-color-darker-1) !important;
}</style>
