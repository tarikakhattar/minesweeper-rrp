import {} from '@w2k/ui';
export const desktopColorSchemeItems = {
...
export const desktopColorSchemeSelectOptions = Object.fromEntries(Object.entries(desktopColorSchemeItems).map(([key, item]) => [key, item.displayName]));
export const defaultDesktopColorScheme = {
