...
export class Configuration {
     ...
     *   Result.
     */
    create(buf: Buffer | undefined, filePath: string | undefined): Promise<Result | undefined>;
    /** @type {FindUp<Result>} */
 ...
 */
export type Callback = (error: Error | undefined, result?: Result | undefined) => undefined;
/**
