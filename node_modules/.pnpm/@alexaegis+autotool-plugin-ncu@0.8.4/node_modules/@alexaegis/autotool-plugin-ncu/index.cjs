...
const name = "@alexaegis/autotool-plugin-ncu";
const description = "ncu config and scripts";
const version = "0.8.4";
const license = "MIT";
const archetype = {
  platform: "node",
...
const scripts = {
  ...
  publint: "BUILD_REASON='publish' turbo run publint_ --concurrency 16 --cache-dir .cache/turbo --filter @alexaegis/autotool-plugin-ncu",
  publint_: "publint dist",
  all: "BUILD_REASON='publish' turbo run all_ --concurrency 16 --cache-dir .cache/turbo --filter @alexaegis/autotool-plugin-ncu",
    ...
    elements: [
      {
        ...
        sourceFile: node_path.join("static", "ncurc.json"),
        targetFile: node_path.join(".config", ".ncurc.json")
      },
      {
