...
const svelteNonKitCommonSetupPlugin = {
  ...
  elements: [
    ...
    },
    {
      ...
      packageJsonFilter: {
        scripts: {
          postinstall: predicate.contains("svelte-kit sync")
        }
      },
      data: {
        scripts: {
    ...
    },
    {
      ...
      sourceFile: node_path.join("static", "package-svelte-tsconfig.json")
    }
  ]
};
...
const svelteKitCommonSetupPlugin = {
  ...
  elements: [
    ...
    },
    {
      ...
      targetFile: "tsconfig.json",
      sourcePluginPackageName: packageJson.name,
      sourceFile: node_path.join("static", "package-sveltekit-tsconfig.json")
    }
  ]
};
const svelteKitAppSetupPlugin = {
  ...
  elements: [
    ...
    },
    {
      ...
      packageKind: "regular",
      formatWithPrettier: true,
      sourceFile: node_path.join("static", "sveltekit.config.txt"),
    ...
    },
    {
      ...
      executor: "fileCopy",
      packageKind: "regular",
      sourceFile: node_path.join("static", "vite-sveltekit-app.config.ts"),
...
const svelteNonKitAppSetupPlugin = {
  ...
  elements: [
    ...
    },
    {
      ...
      executor: "fileCopy",
      packageKind: "regular",
      sourceFile: node_path.join("static", "vite-svelte-app.config.ts"),
      targetFile: "vite.config.ts",
      sourcePluginPackageName: packageJson.name
    },
    {
      ...
      packageKind: "regular",
      formatWithPrettier: true,
      sourceFile: node_path.join("static", "svelte.config.txt"),
      targetFile: "svelte.config.js",
      sourcePluginPackageName: packageJson.name
    }
  ]
...
const svelteLibarySetupPlugin = {
  ...
  elements: [
    ...
    },
    {
      ...
      packageKind: "regular",
      formatWithPrettier: true,
      sourceFile: node_path.join("static", "sveltelib.config.txt"),
      targetFile: "svelte.config.js",
      sourcePluginPackageName: packageJson.name
    }
  ]
...
exports.svelteAppCommonSetupPlugin = svelteAppCommonSetupPlugin;
exports.svelteCommonSetupPlugin = svelteCommonSetupPlugin;
exports.svelteKitAppSetupPlugin = svelteKitAppSetupPlugin;
exports.svelteKitCommonSetupPlugin = svelteKitCommonSetupPlugin;
exports.svelteLibarySetupPlugin = svelteLibarySetupPlugin;
exports.svelteNonKitAppSetupPlugin = svelteNonKitAppSetupPlugin;
exports.svelteNonKitCommonSetupPlugin = svelteNonKitCommonSetupPlugin;
