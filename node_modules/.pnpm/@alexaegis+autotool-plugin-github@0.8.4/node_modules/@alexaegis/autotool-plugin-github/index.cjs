...
const name = "@alexaegis/autotool-plugin-github";
const description = "My github config";
const version = "0.8.4";
const license = "MIT";
const archetype = {
  platform: "node",
...
const scripts = {
  build: "turbo run build-lib_ --concurrency 16 --cache-dir .cache/turbo --filter @alexaegis/autotool-plugin-github",
  "build-lib_": "vite build",
  "lint:depcheck": "turbo run lint:depcheck_ --concurrency 16 --cache-dir .cache/turbo --filter @alexaegis/autotool-plugin-github",
  ...
  publint: "BUILD_REASON='publish' turbo run publint_ --concurrency 16 --cache-dir .cache/turbo --filter @alexaegis/autotool-plugin-github",
  publint_: "publint dist",
  all: "BUILD_REASON='publish' turbo run all_ --concurrency 16 --cache-dir .cache/turbo --filter @alexaegis/autotool-plugin-github",
    ...
    elements: [
      {
        ...
        executor: "fileCopy",
        packageKind: "root",
        targetFile: node_path.join(".github", "ISSUE_TEMPLATE", "bug_report.yml"),
        sourcePluginPackageName: packageJson.name,
        sourceFile: node_path.join("static", "bug_report.yml")
      },
      {
        description: "github feature_request.yml file",
        executor: "fileCopy",
        packageKind: "root",
        targetFile: node_path.join(".github", "ISSUE_TEMPLATE", "feature_request.yml"),
        sourcePluginPackageName: packageJson.name,
        sourceFile: node_path.join("static", "feature_request.yml")
      },
      {
        description: "github funding.yml file",
        executor: "fileCopy",
        packageKind: "root",
        targetFile: node_path.join(".github", "funding.yml"),
        sourcePluginPackageName: packageJson.name,
        sourceFile: node_path.join("static", "funding.yml")
      },
      {
        description: "github cicd.yml file",
        executor: "fileCopy",
        packageKind: "root",
        targetFile: node_path.join(".github", "workflows", "cicd.yml"),
        sourcePluginPackageName: packageJson.name,
        sourceFile: node_path.join("static", "cicd.yml")
      }
    ]
  };
};
