    ...
    elements: [
      {
        ...
        sourceFile: node_path.join("static", "vite-lib.config.ts"),
      ...
      },
      {
        ...
        packageKind: "regular",
        formatWithPrettier: true,
        sourceFile: node_path.join("static", "vite-jslib.config.ts"),
        targetFile: "vite.config.ts",
        sourcePluginPackageName: packageJson.name
      },
      {
      ...
      },
      {
        ...
        packageKind: "regular",
        packageJsonFilter: {
          name: predicate.not(predicate.equal("@alexaegis/vite")),
          // Don't add it for itself, `vite` itself is a regular dependency of it anyway
          archetype: {
            kind: predicate.equal("lib"),
            framework: predicate.not(predicate.contains("svelte"))
      ...
      },
      {
        ...
        packageJsonFilter: {
          archetype: {
            kind: "lib",
            framework: predicate.and(predicate.not(predicate.contains("svelte")), predicate.not(predicate.contains("angular")))
          }
        },
        data: {
          scripts: {
      ...
      },
      {
        ...
        packageKind: "regular",
        formatWithPrettier: true,
        sourceFile: node_path.join("static", "dev.js.txt"),
        targetFile: "dev.js",
        sourcePluginPackageName: packageJson.name
      },
      {
