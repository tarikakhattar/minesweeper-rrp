import { not, contains, or, equal } from "@alexaegis/predicate";
import { getEncodedArchetype } from "@alexaegis/workspace-tools";
  ...
  return {
    ...
    elements: [
      ...
      ...archetypeFlavours.map((archetype2) => {
        const flavour = getEncodedArchetype(archetype2);
        return {
