...
const standardVersion = require("@alexaegis/standard-version");
...
const getLocalPackageNames = () => {
  return standardVersion.collectPackages().subPackages.map(
...
exports.createCommitlintConfig = createCommitlintConfig;
exports.getLocalPackageNames = getLocalPackageNames;
