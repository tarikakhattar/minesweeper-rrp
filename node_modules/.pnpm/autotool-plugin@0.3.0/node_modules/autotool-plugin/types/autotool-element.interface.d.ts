...
import type { AutotoolPluginElementPackageTargetKind, AutotoolPluginObject } from './autotool-plugin.interface.js';
...
export interface AutotoolElement<Executor extends string = string> extends UntargetedAutotoolElement<Executor> {
    /**
...
export type ElementForPackage<Element extends UntargetedAutotoolElement> = Omit<Element, 'packageKind' | 'packageJsonFilter'>;
export interface PackageResolvedElement<Element extends UntargetedAutotoolElement = UntargetedAutotoolElement> {
    element: ElementForPackage<Element>;
    workspacePackage: WorkspacePackage;
    sourcePlugin: AutotoolPluginObject<Element> | undefined;
}
export type AppliedElement<Element extends UntargetedAutotoolElement = UntargetedAutotoolElement> = Omit<ElementForPackage<Element>, 'targetFile' | 'targetFilePatterns' | 'type'>;
//# sourceMappingURL=autotool-element.interface.d.ts.map