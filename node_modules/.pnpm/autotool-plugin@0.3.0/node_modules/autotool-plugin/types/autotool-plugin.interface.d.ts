...
type ExecutorsOf<Elements extends UntargetedAutotoolElement> = Elements extends UntargetedAutotoolElement<infer U> ? Record<U, AutotoolElementExecutor<Elements>> : never;
export interface AutotoolPluginObject<Elements extends UntargetedAutotoolElement = never> extends AutotoolPluginFilter {
    /**
...
export type AutotoolPluginFactory<Elements extends AutotoolElement = DefaultAutotoolElements> = (options: NormalizedAutotoolPluginOptions) => Awaitable<AutotoolPluginObject<Elements>> | Awaitable<AutotoolPluginObject<Elements>[]>;
export type AutotoolPlugin<Elements extends AutotoolElement = DefaultAutotoolElements> = Awaitable<AutotoolPluginObject<Elements>> | Awaitable<AutotoolPluginObject<Elements>[]> | Awaitable<AutotoolPluginFactory<Elements>> | Awaitable<AutotoolPluginFactory<Elements>[]>;
export {};
//# sourceMappingURL=autotool-plugin.interface.d.ts.map