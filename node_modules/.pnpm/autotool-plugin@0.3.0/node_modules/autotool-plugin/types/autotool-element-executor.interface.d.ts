...
export interface AutotoolElementExecutor<Element extends UntargetedAutotoolElement> {
    ...
    execute: (element: Element, target: ElementTarget, options: AutotoolElementApplyOptions) => Awaitable<void>;
    /**
     ...
     */
    consolidate?: ((elements: AppliedElement<Element>[]) => AppliedElement<Element>[] | AppliedElement<Element> | undefined) | undefined;
}
export interface InternalAutotoolElementExecutor<Element extends UntargetedAutotoolElement> extends AutotoolElementExecutor<Element> {
    sourcePlugin: AutotoolPluginObject<Element>;
}
//# sourceMappingURL=autotool-element-executor.interface.d.ts.map