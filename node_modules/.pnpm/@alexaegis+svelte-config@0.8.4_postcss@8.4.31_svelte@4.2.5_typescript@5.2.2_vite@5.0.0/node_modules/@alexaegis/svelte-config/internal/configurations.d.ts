 ...
 */
export const libConfiguration: import('./types.js').Config;
/**
 * Enables the vite inspector on `shift`
 *
 * @type {import('./types.js').Config}
 */
export const spaConfiguration: import('./types.js').Config;
/**
 ...
 * @type {import('./types.js').Config}
 */
export const kitConfiguration: import('./types.js').Config;
