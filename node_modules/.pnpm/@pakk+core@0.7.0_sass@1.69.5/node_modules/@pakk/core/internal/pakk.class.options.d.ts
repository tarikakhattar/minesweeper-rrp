...
import { type CwdOption, type WriteJsonOptions } from '@alexaegis/fs';
import { type LogLevelOption, type LoggerOption } from '@alexaegis/logging';
import type { PackageJson } from '@alexaegis/workspace-tools';
import type { LibraryFormats, LibraryOptions } from 'vite';
import { type AutoBinOptions } from '../plugins/bin/auto-bin.class.options.js';
import { type AutoExportOptions, type AutoExportStaticOptions, type NormalizedAutoSortPackageJsonOptions, type PackageJsonKindType, type PakkFeatureName } from '../index.js';
import { type AutoMetadataOptions } from '../plugins/metadata/auto-metadata.class.options.js';
...
export interface PakkOptions extends WriteJsonOptions, CwdOption, LoggerOption, LogLevelOption, AutoBinOptions, AutoExportOptions, AutoExportStaticOptions, AutoMetadataOptions {
    /**
...
export type NormalizedPakkOptions = Defined<Replace<Omit<PakkOptions, 'targetPackageJsonKind'>, {
    filterFeatures: RegExp[];
}>> & Pick<PakkOptions, 'targetPackageJsonKind'> & NormalizedAutoSortPackageJsonOptions;
export declare const normalizePakkOptions: (options?: PakkOptions) => NormalizedPakkOptions;
//# sourceMappingURL=pakk.class.options.d.ts.map