...
export type PathVariantMap<Variants extends AllExportPathCombinations | AllBinPathCombinations = AllExportPathCombinations | AllBinPathCombinations> = Record<Variants, string>;
/**
 ...
 */
export type EntryPathVariantMap<Variants extends AllExportPathCombinations | AllBinPathCombinations = AllExportPathCombinations | AllBinPathCombinations> = Record<string, PathVariantMap<Variants>>;
//# sourceMappingURL=export-map.type.d.ts.map