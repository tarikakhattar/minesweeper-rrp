...
export declare const normalizeAutoSortPackageJsonOptions: (options?: AutoSortPackageJsonOptions) => NormalizedAutoSortPackageJsonOptions;
//# sourceMappingURL=auto-sort-package-json.class.options.d.ts.map