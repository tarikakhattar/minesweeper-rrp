...
import type { PackageJson, RegularWorkspacePackage, WorkspacePackage } from '@alexaegis/workspace-tools';
...
export interface PakkFeature {
     ...
     * Runs after `update`
     */
    process?: (packageJson: PackageJson, pathContext: PackageExportPathContext) => Awaitable<PackageJson | PackageJson[] | undefined>;
    /**
     ...
     */
    postprocess?: (workspacePackage: RegularWorkspacePackage, sourcePackageJsonTarget: PackageJsonKindType) => PackageJson;
}
//# sourceMappingURL=pakk-feature.type.d.ts.map